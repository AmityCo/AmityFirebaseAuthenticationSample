package co.amity.firebaseauthsample.data.remote

import co.amity.firebaseauthsample.data.local.User
...
class AuthRepositoryImp @Inject constructor(
    ...
    override suspend fun amityLogIn() = AmityCoreClient.login(userId = currentUserId)
        .build()
        .submit()
        .toSuspend()
}
